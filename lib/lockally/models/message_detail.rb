...
module Lockally
  ...
  class MessageDetail < ApiModelBase
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Lockally::MessageDetail` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Lockally::MessageDetail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bounce_reason')
        self.bounce_reason = attributes[:'bounce_reason']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["queued", "sending", "delivered", "bounced", "deferred", "complaint"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["queued", "sending", "delivered", "bounced", "deferred", "complaint"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] queued_at Value to be assigned
    def queued_at=(queued_at)
      if queued_at.nil?
        fail ArgumentError, 'queued_at cannot be nil'
      end
    ...
    def hash
      [id, tenant_id, message_id, sender, recipients, subject, status, queued_at, updated_at, bounce_reason, size_bytes, from, to, cc, bcc, text, html, headers].hash
    end
