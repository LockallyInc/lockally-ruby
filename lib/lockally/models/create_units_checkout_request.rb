...
module Lockally
  class CreateUnitsCheckoutRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Lockally::CreateUnitsCheckoutRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Lockally::CreateUnitsCheckoutRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      bundle_validator = EnumAttributeValidator.new('String', ["1k", "10k", "50k", "100k", "1pkt", "5pkt", "10pkt", "20pkt"])
      return false unless bundle_validator.valid?(@bundle)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] bundle Object to be assigned
    def bundle=(bundle)
      validator = EnumAttributeValidator.new('String', ["1k", "10k", "50k", "100k", "1pkt", "5pkt", "10pkt", "20pkt"])
      unless validator.valid?(bundle)
        fail ArgumentError, "invalid value for \"bundle\", must be one of #{validator.allowable_values}."
      end
      @bundle = bundle
    end
