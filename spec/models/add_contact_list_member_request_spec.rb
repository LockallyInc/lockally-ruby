...
# Unit tests for Lockally::AddContactListMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::AddContactListMemberRequest do
  #let(:instance) { Lockally::AddContactListMemberRequest.new }

  describe 'test an instance of AddContactListMemberRequest' do
    it 'should create an instance of AddContactListMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::AddContactListMemberRequest)
    end
  end
