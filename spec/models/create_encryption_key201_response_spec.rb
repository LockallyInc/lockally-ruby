...
# Unit tests for Lockally::CreateEncryptionKey201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateEncryptionKey201Response do
  #let(:instance) { Lockally::CreateEncryptionKey201Response.new }

  describe 'test an instance of CreateEncryptionKey201Response' do
    it 'should create an instance of CreateEncryptionKey201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateEncryptionKey201Response)
    end
  end
