...
# Unit tests for Lockally::MessageStatsWindow
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MessageStatsWindow do
  #let(:instance) { Lockally::MessageStatsWindow.new }

  describe 'test an instance of MessageStatsWindow' do
    it 'should create an instance of MessageStatsWindow' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MessageStatsWindow)
    end
  end
