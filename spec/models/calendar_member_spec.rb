...
# Unit tests for Lockally::CalendarMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CalendarMember do
  #let(:instance) { Lockally::CalendarMember.new }

  describe 'test an instance of CalendarMember' do
    it 'should create an instance of CalendarMember' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CalendarMember)
    end
  end
