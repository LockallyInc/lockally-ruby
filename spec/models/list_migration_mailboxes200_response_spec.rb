...
# Unit tests for Lockally::ListMigrationMailboxes200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListMigrationMailboxes200Response do
  #let(:instance) { Lockally::ListMigrationMailboxes200Response.new }

  describe 'test an instance of ListMigrationMailboxes200Response' do
    it 'should create an instance of ListMigrationMailboxes200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListMigrationMailboxes200Response)
    end
  end
