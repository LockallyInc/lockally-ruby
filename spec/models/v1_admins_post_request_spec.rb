...
# Unit tests for Lockally::V1AdminsPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1AdminsPostRequest do
  #let(:instance) { Lockally::V1AdminsPostRequest.new }

  describe 'test an instance of V1AdminsPostRequest' do
    it 'should create an instance of V1AdminsPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1AdminsPostRequest)
    end
  end
