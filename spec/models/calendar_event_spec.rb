...
# Unit tests for Lockally::CalendarEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CalendarEvent do
  #let(:instance) { Lockally::CalendarEvent.new }

  describe 'test an instance of CalendarEvent' do
    it 'should create an instance of CalendarEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CalendarEvent)
    end
  end
