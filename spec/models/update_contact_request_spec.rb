...
# Unit tests for Lockally::UpdateContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UpdateContactRequest do
  #let(:instance) { Lockally::UpdateContactRequest.new }

  describe 'test an instance of UpdateContactRequest' do
    it 'should create an instance of UpdateContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UpdateContactRequest)
    end
  end
