...
# Unit tests for Lockally::ListCalendarEvents200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListCalendarEvents200Response do
  #let(:instance) { Lockally::ListCalendarEvents200Response.new }

  describe 'test an instance of ListCalendarEvents200Response' do
    it 'should create an instance of ListCalendarEvents200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListCalendarEvents200Response)
    end
  end
