...
# Unit tests for Lockally::SignupRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::SignupRequest do
  #let(:instance) { Lockally::SignupRequest.new }

  describe 'test an instance of SignupRequest' do
    it 'should create an instance of SignupRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::SignupRequest)
    end
  end
