...
# Unit tests for Lockally::CreateCalendarEventRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateCalendarEventRequest do
  #let(:instance) { Lockally::CreateCalendarEventRequest.new }

  describe 'test an instance of CreateCalendarEventRequest' do
    it 'should create an instance of CreateCalendarEventRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateCalendarEventRequest)
    end
  end
