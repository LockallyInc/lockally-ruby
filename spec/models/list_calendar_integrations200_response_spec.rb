...
# Unit tests for Lockally::ListCalendarIntegrations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListCalendarIntegrations200Response do
  #let(:instance) { Lockally::ListCalendarIntegrations200Response.new }

  describe 'test an instance of ListCalendarIntegrations200Response' do
    it 'should create an instance of ListCalendarIntegrations200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListCalendarIntegrations200Response)
    end
  end
