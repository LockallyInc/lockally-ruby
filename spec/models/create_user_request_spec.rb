...
# Unit tests for Lockally::CreateUserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateUserRequest do
  #let(:instance) { Lockally::CreateUserRequest.new }

  describe 'test an instance of CreateUserRequest' do
    it 'should create an instance of CreateUserRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateUserRequest)
    end
  end
