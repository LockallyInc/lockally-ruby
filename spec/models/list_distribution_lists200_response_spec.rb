...
# Unit tests for Lockally::ListDistributionLists200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListDistributionLists200Response do
  #let(:instance) { Lockally::ListDistributionLists200Response.new }

  describe 'test an instance of ListDistributionLists200Response' do
    it 'should create an instance of ListDistributionLists200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListDistributionLists200Response)
    end
  end
