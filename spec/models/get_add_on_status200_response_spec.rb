...
# Unit tests for Lockally::GetAddOnStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetAddOnStatus200Response do
  #let(:instance) { Lockally::GetAddOnStatus200Response.new }

  describe 'test an instance of GetAddOnStatus200Response' do
    it 'should create an instance of GetAddOnStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetAddOnStatus200Response)
    end
  end
