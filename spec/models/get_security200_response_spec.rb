...
# Unit tests for Lockally::GetSecurity200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetSecurity200Response do
  #let(:instance) { Lockally::GetSecurity200Response.new }

  describe 'test an instance of GetSecurity200Response' do
    it 'should create an instance of GetSecurity200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetSecurity200Response)
    end
  end
