...
# Unit tests for Lockally::Mailbox
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::Mailbox do
  #let(:instance) { Lockally::Mailbox.new }

  describe 'test an instance of Mailbox' do
    it 'should create an instance of Mailbox' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::Mailbox)
    end
  end
  ...
  describe 'test attribute "soft_deleted_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
