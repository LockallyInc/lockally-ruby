...
# Unit tests for Lockally::V1AdminLoginPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1AdminLoginPostRequest do
  #let(:instance) { Lockally::V1AdminLoginPostRequest.new }

  describe 'test an instance of V1AdminLoginPostRequest' do
    it 'should create an instance of V1AdminLoginPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1AdminLoginPostRequest)
    end
  end
