...
# Unit tests for Lockally::TemplateInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::TemplateInput do
  #let(:instance) { Lockally::TemplateInput.new }

  describe 'test an instance of TemplateInput' do
    it 'should create an instance of TemplateInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::TemplateInput)
    end
  end
