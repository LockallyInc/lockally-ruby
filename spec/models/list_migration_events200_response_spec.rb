...
# Unit tests for Lockally::ListMigrationEvents200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListMigrationEvents200Response do
  #let(:instance) { Lockally::ListMigrationEvents200Response.new }

  describe 'test an instance of ListMigrationEvents200Response' do
    it 'should create an instance of ListMigrationEvents200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListMigrationEvents200Response)
    end
  end
