...
# Unit tests for Lockally::SendMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::SendMessage do
  #let(:instance) { Lockally::SendMessage.new }

  describe 'test an instance of SendMessage' do
    it 'should create an instance of SendMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::SendMessage)
    end
  end
