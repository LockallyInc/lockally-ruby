...
# Unit tests for Lockally::GetDirectoryActivity200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetDirectoryActivity200ResponseDataInner do
  #let(:instance) { Lockally::GetDirectoryActivity200ResponseDataInner.new }

  describe 'test an instance of GetDirectoryActivity200ResponseDataInner' do
    it 'should create an instance of GetDirectoryActivity200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetDirectoryActivity200ResponseDataInner)
    end
  end
