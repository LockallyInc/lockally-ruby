...
# Unit tests for Lockally::AddCalendarMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::AddCalendarMemberRequest do
  #let(:instance) { Lockally::AddCalendarMemberRequest.new }

  describe 'test an instance of AddCalendarMemberRequest' do
    it 'should create an instance of AddCalendarMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::AddCalendarMemberRequest)
    end
  end
