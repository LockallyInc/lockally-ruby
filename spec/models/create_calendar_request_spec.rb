...
# Unit tests for Lockally::CreateCalendarRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateCalendarRequest do
  #let(:instance) { Lockally::CreateCalendarRequest.new }

  describe 'test an instance of CreateCalendarRequest' do
    it 'should create an instance of CreateCalendarRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateCalendarRequest)
    end
  end
