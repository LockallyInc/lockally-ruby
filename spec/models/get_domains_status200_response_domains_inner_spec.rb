...
# Unit tests for Lockally::GetDomainsStatus200ResponseDomainsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetDomainsStatus200ResponseDomainsInner do
  #let(:instance) { Lockally::GetDomainsStatus200ResponseDomainsInner.new }

  describe 'test an instance of GetDomainsStatus200ResponseDomainsInner' do
    it 'should create an instance of GetDomainsStatus200ResponseDomainsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetDomainsStatus200ResponseDomainsInner)
    end
  end
