...
# Unit tests for Lockally::MessageStats
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MessageStats do
  #let(:instance) { Lockally::MessageStats.new }

  describe 'test an instance of MessageStats' do
    it 'should create an instance of MessageStats' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MessageStats)
    end
  end
