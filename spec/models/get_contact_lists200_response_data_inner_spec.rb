...
# Unit tests for Lockally::GetContactLists200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetContactLists200ResponseDataInner do
  #let(:instance) { Lockally::GetContactLists200ResponseDataInner.new }

  describe 'test an instance of GetContactLists200ResponseDataInner' do
    it 'should create an instance of GetContactLists200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetContactLists200ResponseDataInner)
    end
  end
