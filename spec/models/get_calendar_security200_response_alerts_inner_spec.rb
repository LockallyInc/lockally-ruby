...
# Unit tests for Lockally::GetCalendarSecurity200ResponseAlertsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetCalendarSecurity200ResponseAlertsInner do
  #let(:instance) { Lockally::GetCalendarSecurity200ResponseAlertsInner.new }

  describe 'test an instance of GetCalendarSecurity200ResponseAlertsInner' do
    it 'should create an instance of GetCalendarSecurity200ResponseAlertsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetCalendarSecurity200ResponseAlertsInner)
    end
  end
  ...
  describe 'test attribute "level"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["critical", "warning"])
