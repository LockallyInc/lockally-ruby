...
# Unit tests for Lockally::UserEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UserEvent do
  #let(:instance) { Lockally::UserEvent.new }

  describe 'test an instance of UserEvent' do
    it 'should create an instance of UserEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UserEvent)
    end
  end
  ...
  describe 'test attribute "days_inactive"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
