...
# Unit tests for Lockally::HealthzGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::HealthzGet200Response do
  #let(:instance) { Lockally::HealthzGet200Response.new }

  describe 'test an instance of HealthzGet200Response' do
    it 'should create an instance of HealthzGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::HealthzGet200Response)
    end
  end
