...
# Unit tests for Lockally::ListContactLists200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListContactLists200Response do
  #let(:instance) { Lockally::ListContactLists200Response.new }

  describe 'test an instance of ListContactLists200Response' do
    it 'should create an instance of ListContactLists200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListContactLists200Response)
    end
  end
