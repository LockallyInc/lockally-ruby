...
# Unit tests for Lockally::GetContactList200ResponseMembersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetContactList200ResponseMembersInner do
  #let(:instance) { Lockally::GetContactList200ResponseMembersInner.new }

  describe 'test an instance of GetContactList200ResponseMembersInner' do
    it 'should create an instance of GetContactList200ResponseMembersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetContactList200ResponseMembersInner)
    end
  end
