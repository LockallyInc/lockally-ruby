...
# Unit tests for Lockally::V1WebhooksPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1WebhooksPostRequest do
  #let(:instance) { Lockally::V1WebhooksPostRequest.new }

  describe 'test an instance of V1WebhooksPostRequest' do
    it 'should create an instance of V1WebhooksPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1WebhooksPostRequest)
    end
  end
