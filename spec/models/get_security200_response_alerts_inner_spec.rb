...
# Unit tests for Lockally::GetSecurity200ResponseAlertsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetSecurity200ResponseAlertsInner do
  #let(:instance) { Lockally::GetSecurity200ResponseAlertsInner.new }

  describe 'test an instance of GetSecurity200ResponseAlertsInner' do
    it 'should create an instance of GetSecurity200ResponseAlertsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetSecurity200ResponseAlertsInner)
    end
  end
  ...
  describe 'test attribute "level"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["info", "warning", "critical"])
