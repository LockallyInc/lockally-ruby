...
# Unit tests for Lockally::UpdateCalendarEventRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UpdateCalendarEventRequest do
  #let(:instance) { Lockally::UpdateCalendarEventRequest.new }

  describe 'test an instance of UpdateCalendarEventRequest' do
    it 'should create an instance of UpdateCalendarEventRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UpdateCalendarEventRequest)
    end
  end
