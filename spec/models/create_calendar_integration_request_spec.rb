...
# Unit tests for Lockally::CreateCalendarIntegrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateCalendarIntegrationRequest do
  #let(:instance) { Lockally::CreateCalendarIntegrationRequest.new }

  describe 'test an instance of CreateCalendarIntegrationRequest' do
    it 'should create an instance of CreateCalendarIntegrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateCalendarIntegrationRequest)
    end
  end
