...
# Unit tests for Lockally::GetIntegrationsSummary200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetIntegrationsSummary200Response do
  #let(:instance) { Lockally::GetIntegrationsSummary200Response.new }

  describe 'test an instance of GetIntegrationsSummary200Response' do
    it 'should create an instance of GetIntegrationsSummary200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetIntegrationsSummary200Response)
    end
  end

  describe 'test attribute "api_requests_today"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "active_api_keys"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "webhook_failures"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
