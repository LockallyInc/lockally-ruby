...
# Unit tests for Lockally::DNSRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::DNSRecord do
  #let(:instance) { Lockally::DNSRecord.new }

  describe 'test an instance of DNSRecord' do
    it 'should create an instance of DNSRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::DNSRecord)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["TXT", "MX"])
  ...
  describe 'test attribute "purpose"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["verification", "spf", "dkim", "mx-primary", "mx-backup", "dmarc"])
      # validator.allowable_values.each do |value|
