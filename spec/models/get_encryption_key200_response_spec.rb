...
# Unit tests for Lockally::GetEncryptionKey200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetEncryptionKey200Response do
  #let(:instance) { Lockally::GetEncryptionKey200Response.new }

  describe 'test an instance of GetEncryptionKey200Response' do
    it 'should create an instance of GetEncryptionKey200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetEncryptionKey200Response)
    end
  end
