...
# Unit tests for Lockally::ListCalendarMembers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListCalendarMembers200Response do
  #let(:instance) { Lockally::ListCalendarMembers200Response.new }

  describe 'test an instance of ListCalendarMembers200Response' do
    it 'should create an instance of ListCalendarMembers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListCalendarMembers200Response)
    end
  end
