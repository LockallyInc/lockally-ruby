...
# Unit tests for Lockally::V1SendPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1SendPostRequest do
  #let(:instance) { Lockally::V1SendPostRequest.new }

  describe 'test an instance of V1SendPostRequest' do
    it 'should create an instance of V1SendPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1SendPostRequest)
    end
  end
