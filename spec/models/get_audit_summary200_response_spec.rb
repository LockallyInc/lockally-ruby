...
# Unit tests for Lockally::GetAuditSummary200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetAuditSummary200Response do
  #let(:instance) { Lockally::GetAuditSummary200Response.new }

  describe 'test an instance of GetAuditSummary200Response' do
    it 'should create an instance of GetAuditSummary200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetAuditSummary200Response)
    end
  end

  describe 'test attribute "admin_actions_today"' do
    it 'should work' do
  ...
  describe 'test attribute "recent_exports"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "deleted_mailboxes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
