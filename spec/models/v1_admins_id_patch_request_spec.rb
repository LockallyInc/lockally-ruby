...
# Unit tests for Lockally::V1AdminsIdPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1AdminsIdPatchRequest do
  #let(:instance) { Lockally::V1AdminsIdPatchRequest.new }

  describe 'test an instance of V1AdminsIdPatchRequest' do
    it 'should create an instance of V1AdminsIdPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1AdminsIdPatchRequest)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["admin", "viewer"])
