...
# Unit tests for Lockally::AdminFull
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::AdminFull do
  #let(:instance) { Lockally::AdminFull.new }

  describe 'test an instance of AdminFull' do
    it 'should create an instance of AdminFull' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::AdminFull)
    end
  end
