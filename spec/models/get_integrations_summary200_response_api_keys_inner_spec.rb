...
# Unit tests for Lockally::GetIntegrationsSummary200ResponseApiKeysInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetIntegrationsSummary200ResponseApiKeysInner do
  #let(:instance) { Lockally::GetIntegrationsSummary200ResponseApiKeysInner.new }

  describe 'test an instance of GetIntegrationsSummary200ResponseApiKeysInner' do
    it 'should create an instance of GetIntegrationsSummary200ResponseApiKeysInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetIntegrationsSummary200ResponseApiKeysInner)
    end
  end
