...
# Unit tests for Lockally::GetStorage200ResponseTopMailboxesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetStorage200ResponseTopMailboxesInner do
  #let(:instance) { Lockally::GetStorage200ResponseTopMailboxesInner.new }

  describe 'test an instance of GetStorage200ResponseTopMailboxesInner' do
    it 'should create an instance of GetStorage200ResponseTopMailboxesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetStorage200ResponseTopMailboxesInner)
    end
  end
