...
# Unit tests for Lockally::GetIntegrationsSummary200ResponseWebhooksInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetIntegrationsSummary200ResponseWebhooksInner do
  #let(:instance) { Lockally::GetIntegrationsSummary200ResponseWebhooksInner.new }

  describe 'test an instance of GetIntegrationsSummary200ResponseWebhooksInner' do
    it 'should create an instance of GetIntegrationsSummary200ResponseWebhooksInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetIntegrationsSummary200ResponseWebhooksInner)
    end
  end
