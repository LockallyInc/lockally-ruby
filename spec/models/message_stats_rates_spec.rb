...
# Unit tests for Lockally::MessageStatsRates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MessageStatsRates do
  #let(:instance) { Lockally::MessageStatsRates.new }

  describe 'test an instance of MessageStatsRates' do
    it 'should create an instance of MessageStatsRates' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MessageStatsRates)
    end
  end
