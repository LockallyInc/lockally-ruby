...
# Unit tests for Lockally::CreateBillingCheckoutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateBillingCheckoutRequest do
  #let(:instance) { Lockally::CreateBillingCheckoutRequest.new }
  ...
  describe 'test an instance of CreateBillingCheckoutRequest' do
    it 'should create an instance of CreateBillingCheckoutRequest' do
      ...
      #expect(instance).to be_instance_of(Lockally::CreateBillingCheckoutRequest)
    end
  end
  ...
  describe 'test attribute "plan"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["free", "founder", "starter", "pro", "scale"])
