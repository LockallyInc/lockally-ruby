...
# Unit tests for Lockally::VacationResponder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::VacationResponder do
  #let(:instance) { Lockally::VacationResponder.new }

  describe 'test an instance of VacationResponder' do
    it 'should create an instance of VacationResponder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::VacationResponder)
    end
  end
