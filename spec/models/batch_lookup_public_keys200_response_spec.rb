...
# Unit tests for Lockally::BatchLookupPublicKeys200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::BatchLookupPublicKeys200Response do
  #let(:instance) { Lockally::BatchLookupPublicKeys200Response.new }

  describe 'test an instance of BatchLookupPublicKeys200Response' do
    it 'should create an instance of BatchLookupPublicKeys200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::BatchLookupPublicKeys200Response)
    end
  end
