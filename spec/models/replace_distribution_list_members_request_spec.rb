...
# Unit tests for Lockally::ReplaceDistributionListMembersRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ReplaceDistributionListMembersRequest do
  #let(:instance) { Lockally::ReplaceDistributionListMembersRequest.new }

  describe 'test an instance of ReplaceDistributionListMembersRequest' do
    it 'should create an instance of ReplaceDistributionListMembersRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ReplaceDistributionListMembersRequest)
    end
  end
