...
# Unit tests for Lockally::GetDomainsStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetDomainsStatus200Response do
  #let(:instance) { Lockally::GetDomainsStatus200Response.new }

  describe 'test an instance of GetDomainsStatus200Response' do
    it 'should create an instance of GetDomainsStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetDomainsStatus200Response)
    end
  end
