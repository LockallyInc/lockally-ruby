...
# Unit tests for Lockally::ListContacts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListContacts200Response do
  #let(:instance) { Lockally::ListContacts200Response.new }
  ...
  describe 'test an instance of ListContacts200Response' do
    it 'should create an instance of ListContacts200Response' do
      ...
      #expect(instance).to be_instance_of(Lockally::ListContacts200Response)
    end
  end
