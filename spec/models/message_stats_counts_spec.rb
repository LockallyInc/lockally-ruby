...
# Unit tests for Lockally::MessageStatsCounts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MessageStatsCounts do
  #let(:instance) { Lockally::MessageStatsCounts.new }

  describe 'test an instance of MessageStatsCounts' do
    it 'should create an instance of MessageStatsCounts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MessageStatsCounts)
    end
  end
  ...
  describe 'test attribute "complaint"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
