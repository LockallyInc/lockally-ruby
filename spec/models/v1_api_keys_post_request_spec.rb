...
# Unit tests for Lockally::V1ApiKeysPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1ApiKeysPostRequest do
  #let(:instance) { Lockally::V1ApiKeysPostRequest.new }

  describe 'test an instance of V1ApiKeysPostRequest' do
    it 'should create an instance of V1ApiKeysPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1ApiKeysPostRequest)
    end
  end
  ...
  describe 'test attribute "scopes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["tenant:read", "tenant:admin", "mailboxes:read", "mailboxes:write", "send:read", "send:write", "webhooks:read", "webhooks:write", "domains:read", "domains:write"])
