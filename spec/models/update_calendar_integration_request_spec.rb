...
# Unit tests for Lockally::UpdateCalendarIntegrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UpdateCalendarIntegrationRequest do
  #let(:instance) { Lockally::UpdateCalendarIntegrationRequest.new }

  describe 'test an instance of UpdateCalendarIntegrationRequest' do
    it 'should create an instance of UpdateCalendarIntegrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UpdateCalendarIntegrationRequest)
    end
  end
