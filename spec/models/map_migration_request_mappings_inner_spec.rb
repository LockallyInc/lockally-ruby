...
# Unit tests for Lockally::MapMigrationRequestMappingsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MapMigrationRequestMappingsInner do
  #let(:instance) { Lockally::MapMigrationRequestMappingsInner.new }

  describe 'test an instance of MapMigrationRequestMappingsInner' do
    it 'should create an instance of MapMigrationRequestMappingsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MapMigrationRequestMappingsInner)
    end
  end
