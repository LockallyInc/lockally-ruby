...
# Unit tests for Lockally::DistributionListDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::DistributionListDetail do
  #let(:instance) { Lockally::DistributionListDetail.new }

  describe 'test an instance of DistributionListDetail' do
    it 'should create an instance of DistributionListDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::DistributionListDetail)
    end
  end
