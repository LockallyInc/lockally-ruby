...
# Unit tests for Lockally::V1MailboxesEmailVacationPutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1MailboxesEmailVacationPutRequest do
  #let(:instance) { Lockally::V1MailboxesEmailVacationPutRequest.new }

  describe 'test an instance of V1MailboxesEmailVacationPutRequest' do
    it 'should create an instance of V1MailboxesEmailVacationPutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1MailboxesEmailVacationPutRequest)
    end
  end
