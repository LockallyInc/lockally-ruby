...
# Unit tests for Lockally::V1AliasesPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1AliasesPostRequest do
  #let(:instance) { Lockally::V1AliasesPostRequest.new }

  describe 'test an instance of V1AliasesPostRequest' do
    it 'should create an instance of V1AliasesPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1AliasesPostRequest)
    end
  end

  describe 'test attribute "alias_address"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "alias_target"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
