...
# Unit tests for Lockally::UpdateMigrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UpdateMigrationRequest do
  #let(:instance) { Lockally::UpdateMigrationRequest.new }

  describe 'test an instance of UpdateMigrationRequest' do
    it 'should create an instance of UpdateMigrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UpdateMigrationRequest)
    end
  end
