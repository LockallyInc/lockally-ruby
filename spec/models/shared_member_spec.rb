...
# Unit tests for Lockally::SharedMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::SharedMember do
  #let(:instance) { Lockally::SharedMember.new }

  describe 'test an instance of SharedMember' do
    it 'should create an instance of SharedMember' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::SharedMember)
    end
  end
