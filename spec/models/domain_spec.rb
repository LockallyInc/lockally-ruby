...
# Unit tests for Lockally::Domain
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::Domain do
  #let(:instance) { Lockally::Domain.new }

  describe 'test an instance of Domain' do
    it 'should create an instance of Domain' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::Domain)
    end
  end
  ...
  describe 'test attribute "dkim_public_record"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
