...
# Unit tests for Lockally::UpdateResourceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UpdateResourceRequest do
  #let(:instance) { Lockally::UpdateResourceRequest.new }

  describe 'test an instance of UpdateResourceRequest' do
    it 'should create an instance of UpdateResourceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UpdateResourceRequest)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["meeting_room", "equipment"])
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["available", "active", "disabled"])
      # validator.allowable_values.each do |value|
