...
# Unit tests for Lockally::V1WebhooksGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1WebhooksGet200Response do
  #let(:instance) { Lockally::V1WebhooksGet200Response.new }
  ...
  describe 'test an instance of V1WebhooksGet200Response' do
    it 'should create an instance of V1WebhooksGet200Response' do
      ...
      #expect(instance).to be_instance_of(Lockally::V1WebhooksGet200Response)
    end
  end
