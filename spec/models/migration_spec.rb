...
# Unit tests for Lockally::Migration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::Migration do
  #let(:instance) { Lockally::Migration.new }

  describe 'test an instance of Migration' do
    it 'should create an instance of Migration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::Migration)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["draft", "discovering", "discovered", "mapped", "pilot_running", "pilot_complete", "running", "staged", "cutover_pending", "final_syncing", "validating", "completed", "failed", "cancelled"])
  ...
  describe 'test attribute "source_provider"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "source_summary"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
