...
# Unit tests for Lockally::ContactList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ContactList do
  #let(:instance) { Lockally::ContactList.new }

  describe 'test an instance of ContactList' do
    it 'should create an instance of ContactList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ContactList)
    end
  end
