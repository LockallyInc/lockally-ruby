...
# Unit tests for Lockally::CreateContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateContactRequest do
  #let(:instance) { Lockally::CreateContactRequest.new }

  describe 'test an instance of CreateContactRequest' do
    it 'should create an instance of CreateContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateContactRequest)
    end
  end
