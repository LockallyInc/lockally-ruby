...
# Unit tests for Lockally::CreateMigrationCredentialRequestCredentials
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateMigrationCredentialRequestCredentials do
  #let(:instance) { Lockally::CreateMigrationCredentialRequestCredentials.new }

  describe 'test an instance of CreateMigrationCredentialRequestCredentials' do
    it 'should create an instance of CreateMigrationCredentialRequestCredentials' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateMigrationCredentialRequestCredentials)
    end
  end
