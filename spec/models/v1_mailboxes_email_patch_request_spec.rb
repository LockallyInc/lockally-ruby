...
# Unit tests for Lockally::V1MailboxesEmailPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1MailboxesEmailPatchRequest do
  #let(:instance) { Lockally::V1MailboxesEmailPatchRequest.new }

  describe 'test an instance of V1MailboxesEmailPatchRequest' do
    it 'should create an instance of V1MailboxesEmailPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1MailboxesEmailPatchRequest)
    end
  end
  ...
  describe 'test attribute "quota_bytes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
