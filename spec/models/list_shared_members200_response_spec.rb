...
# Unit tests for Lockally::ListSharedMembers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListSharedMembers200Response do
  #let(:instance) { Lockally::ListSharedMembers200Response.new }

  describe 'test an instance of ListSharedMembers200Response' do
    it 'should create an instance of ListSharedMembers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListSharedMembers200Response)
    end
  end
