...
# Unit tests for Lockally::UpdateCalendarRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UpdateCalendarRequest do
  #let(:instance) { Lockally::UpdateCalendarRequest.new }

  describe 'test an instance of UpdateCalendarRequest' do
    it 'should create an instance of UpdateCalendarRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UpdateCalendarRequest)
    end
  end
