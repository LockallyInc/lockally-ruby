...
# Unit tests for Lockally::ReplaceDistributionListMembers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ReplaceDistributionListMembers200Response do
  #let(:instance) { Lockally::ReplaceDistributionListMembers200Response.new }

  describe 'test an instance of ReplaceDistributionListMembers200Response' do
    it 'should create an instance of ReplaceDistributionListMembers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ReplaceDistributionListMembers200Response)
    end
  end
  ...
  describe 'test attribute "list_address"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
