...
# Unit tests for Lockally::CreateDistributionListRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateDistributionListRequest do
  #let(:instance) { Lockally::CreateDistributionListRequest.new }

  describe 'test an instance of CreateDistributionListRequest' do
    it 'should create an instance of CreateDistributionListRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateDistributionListRequest)
    end
  end
