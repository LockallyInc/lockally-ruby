...
# Unit tests for Lockally::VacationParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::VacationParams do
  #let(:instance) { Lockally::VacationParams.new }

  describe 'test an instance of VacationParams' do
    it 'should create an instance of VacationParams' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::VacationParams)
    end
  end
