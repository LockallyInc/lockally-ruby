...
# Unit tests for Lockally::ActivateAddOn200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ActivateAddOn200Response do
  #let(:instance) { Lockally::ActivateAddOn200Response.new }

  describe 'test an instance of ActivateAddOn200Response' do
    it 'should create an instance of ActivateAddOn200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ActivateAddOn200Response)
    end
  end
