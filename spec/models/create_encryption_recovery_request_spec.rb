...
# Unit tests for Lockally::CreateEncryptionRecoveryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateEncryptionRecoveryRequest do
  #let(:instance) { Lockally::CreateEncryptionRecoveryRequest.new }

  describe 'test an instance of CreateEncryptionRecoveryRequest' do
    it 'should create an instance of CreateEncryptionRecoveryRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateEncryptionRecoveryRequest)
    end
  end

  describe 'test attribute "mailbox_email"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "recovery_blob"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
