...
# Unit tests for Lockally::V1MailboxesPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1MailboxesPostRequest do
  #let(:instance) { Lockally::V1MailboxesPostRequest.new }

  describe 'test an instance of V1MailboxesPostRequest' do
    it 'should create an instance of V1MailboxesPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1MailboxesPostRequest)
    end
  end
