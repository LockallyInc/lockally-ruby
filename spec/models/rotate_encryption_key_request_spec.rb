...
# Unit tests for Lockally::RotateEncryptionKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::RotateEncryptionKeyRequest do
  #let(:instance) { Lockally::RotateEncryptionKeyRequest.new }

  describe 'test an instance of RotateEncryptionKeyRequest' do
    it 'should create an instance of RotateEncryptionKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::RotateEncryptionKeyRequest)
    end
  end
  ...
  describe 'test attribute "kdf_params"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
