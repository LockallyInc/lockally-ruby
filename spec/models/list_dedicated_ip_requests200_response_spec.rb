...
# Unit tests for Lockally::ListDedicatedIPRequests200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListDedicatedIPRequests200Response do
  #let(:instance) { Lockally::ListDedicatedIPRequests200Response.new }

  describe 'test an instance of ListDedicatedIPRequests200Response' do
    it 'should create an instance of ListDedicatedIPRequests200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListDedicatedIPRequests200Response)
    end
  end
