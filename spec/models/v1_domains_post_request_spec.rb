...
# Unit tests for Lockally::V1DomainsPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1DomainsPostRequest do
  #let(:instance) { Lockally::V1DomainsPostRequest.new }

  describe 'test an instance of V1DomainsPostRequest' do
    it 'should create an instance of V1DomainsPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1DomainsPostRequest)
    end
  end
