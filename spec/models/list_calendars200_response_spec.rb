...
# Unit tests for Lockally::ListCalendars200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListCalendars200Response do
  #let(:instance) { Lockally::ListCalendars200Response.new }

  describe 'test an instance of ListCalendars200Response' do
    it 'should create an instance of ListCalendars200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListCalendars200Response)
    end
  end
