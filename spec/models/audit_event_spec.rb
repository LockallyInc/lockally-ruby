...
# Unit tests for Lockally::AuditEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::AuditEvent do
  #let(:instance) { Lockally::AuditEvent.new }

  describe 'test an instance of AuditEvent' do
    it 'should create an instance of AuditEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::AuditEvent)
    end
  end
