...
# Unit tests for Lockally::ListResources200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListResources200Response do
  #let(:instance) { Lockally::ListResources200Response.new }

  describe 'test an instance of ListResources200Response' do
    it 'should create an instance of ListResources200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListResources200Response)
    end
  end
