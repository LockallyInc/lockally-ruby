...
# Unit tests for Lockally::V1DomainsGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1DomainsGet200Response do
  #let(:instance) { Lockally::V1DomainsGet200Response.new }

  describe 'test an instance of V1DomainsGet200Response' do
    it 'should create an instance of V1DomainsGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1DomainsGet200Response)
    end
  end
