...
# Unit tests for Lockally::ListMigrations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListMigrations200Response do
  #let(:instance) { Lockally::ListMigrations200Response.new }

  describe 'test an instance of ListMigrations200Response' do
    it 'should create an instance of ListMigrations200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListMigrations200Response)
    end
  end
