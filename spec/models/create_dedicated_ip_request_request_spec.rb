...
# Unit tests for Lockally::CreateDedicatedIPRequestRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateDedicatedIPRequestRequest do
  #let(:instance) { Lockally::CreateDedicatedIPRequestRequest.new }

  describe 'test an instance of CreateDedicatedIPRequestRequest' do
    it 'should create an instance of CreateDedicatedIPRequestRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateDedicatedIPRequestRequest)
    end
  end
