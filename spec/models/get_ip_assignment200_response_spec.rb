...
# Unit tests for Lockally::GetIPAssignment200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetIPAssignment200Response do
  #let(:instance) { Lockally::GetIPAssignment200Response.new }

  describe 'test an instance of GetIPAssignment200Response' do
    it 'should create an instance of GetIPAssignment200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetIPAssignment200Response)
    end
  end
  ...
  describe 'test attribute "pool_kind"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "dedicated_ip"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
