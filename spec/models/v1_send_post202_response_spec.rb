...
# Unit tests for Lockally::V1SendPost202Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1SendPost202Response do
  #let(:instance) { Lockally::V1SendPost202Response.new }

  describe 'test an instance of V1SendPost202Response' do
    it 'should create an instance of V1SendPost202Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1SendPost202Response)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["queued", "scheduled"])
