...
# Unit tests for Lockally::ModelAlias
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ModelAlias do
  #let(:instance) { Lockally::ModelAlias.new }

  describe 'test an instance of ModelAlias' do
    it 'should create an instance of ModelAlias' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ModelAlias)
    end
  end
