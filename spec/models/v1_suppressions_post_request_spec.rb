...
# Unit tests for Lockally::V1SuppressionsPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1SuppressionsPostRequest do
  #let(:instance) { Lockally::V1SuppressionsPostRequest.new }

  describe 'test an instance of V1SuppressionsPostRequest' do
    it 'should create an instance of V1SuppressionsPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1SuppressionsPostRequest)
    end
  end
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unsubscribe", "complaint", "bounce", "manual"])
