...
# Unit tests for Lockally::ListMigrationCredentials200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListMigrationCredentials200Response do
  #let(:instance) { Lockally::ListMigrationCredentials200Response.new }

  describe 'test an instance of ListMigrationCredentials200Response' do
    it 'should create an instance of ListMigrationCredentials200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListMigrationCredentials200Response)
    end
  end
