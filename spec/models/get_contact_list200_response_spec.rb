...
# Unit tests for Lockally::GetContactList200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetContactList200Response do
  #let(:instance) { Lockally::GetContactList200Response.new }

  describe 'test an instance of GetContactList200Response' do
    it 'should create an instance of GetContactList200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetContactList200Response)
    end
  end
