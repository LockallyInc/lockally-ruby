...
# Unit tests for Lockally::GALSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GALSettings do
  #let(:instance) { Lockally::GALSettings.new }

  describe 'test an instance of GALSettings' do
    it 'should create an instance of GALSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GALSettings)
    end
  end
  ...
  describe 'test attribute "last_index_rebuilt_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
