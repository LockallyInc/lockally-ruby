...
# Unit tests for Lockally::GetContactLists200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetContactLists200Response do
  #let(:instance) { Lockally::GetContactLists200Response.new }

  describe 'test an instance of GetContactLists200Response' do
    it 'should create an instance of GetContactLists200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetContactLists200Response)
    end
  end
