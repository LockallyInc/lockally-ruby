...
# Unit tests for Lockally::GetDirectoryStats200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetDirectoryStats200Response do
  #let(:instance) { Lockally::GetDirectoryStats200Response.new }

  describe 'test an instance of GetDirectoryStats200Response' do
    it 'should create an instance of GetDirectoryStats200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetDirectoryStats200Response)
    end
  end
  ...
  describe 'test attribute "external_contacts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "synced_contacts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "shared_lists"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "directory_groups"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
