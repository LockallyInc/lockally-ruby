...
# Unit tests for Lockally::GetStorage200ResponseTopMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetStorage200ResponseTopMessagesInner do
  #let(:instance) { Lockally::GetStorage200ResponseTopMessagesInner.new }

  describe 'test an instance of GetStorage200ResponseTopMessagesInner' do
    it 'should create an instance of GetStorage200ResponseTopMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetStorage200ResponseTopMessagesInner)
    end
  end
  ...
  describe 'test attribute "filenames"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
