...
# Unit tests for Lockally::GetCalendarSecurity200ResponseDelegatedAccessInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetCalendarSecurity200ResponseDelegatedAccessInner do
  #let(:instance) { Lockally::GetCalendarSecurity200ResponseDelegatedAccessInner.new }

  describe 'test an instance of GetCalendarSecurity200ResponseDelegatedAccessInner' do
    it 'should create an instance of GetCalendarSecurity200ResponseDelegatedAccessInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetCalendarSecurity200ResponseDelegatedAccessInner)
    end
  end
  ...
  describe 'test attribute "granted_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
