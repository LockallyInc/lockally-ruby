...
# Unit tests for Lockally::CreateBillingCheckout200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateBillingCheckout200Response do
  #let(:instance) { Lockally::CreateBillingCheckout200Response.new }

  describe 'test an instance of CreateBillingCheckout200Response' do
    it 'should create an instance of CreateBillingCheckout200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateBillingCheckout200Response)
    end
  end
