...
# Unit tests for Lockally::UnitBundle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UnitBundle do
  #let(:instance) { Lockally::UnitBundle.new }

  describe 'test an instance of UnitBundle' do
    it 'should create an instance of UnitBundle' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UnitBundle)
    end
  end
  ...
  describe 'test attribute "price_naira"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
