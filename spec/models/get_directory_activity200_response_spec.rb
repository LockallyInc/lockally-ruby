...
# Unit tests for Lockally::GetDirectoryActivity200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetDirectoryActivity200Response do
  #let(:instance) { Lockally::GetDirectoryActivity200Response.new }

  describe 'test an instance of GetDirectoryActivity200Response' do
    it 'should create an instance of GetDirectoryActivity200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetDirectoryActivity200Response)
    end
  end
