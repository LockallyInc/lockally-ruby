...
# Unit tests for Lockally::UpdateMigrationMailboxRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::UpdateMigrationMailboxRequest do
  #let(:instance) { Lockally::UpdateMigrationMailboxRequest.new }

  describe 'test an instance of UpdateMigrationMailboxRequest' do
    it 'should create an instance of UpdateMigrationMailboxRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::UpdateMigrationMailboxRequest)
    end
  end
