...
# Unit tests for Lockally::DistributionListSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::DistributionListSummary do
  #let(:instance) { Lockally::DistributionListSummary.new }

  describe 'test an instance of DistributionListSummary' do
    it 'should create an instance of DistributionListSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::DistributionListSummary)
    end
  end
