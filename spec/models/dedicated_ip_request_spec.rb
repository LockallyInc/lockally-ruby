...
# Unit tests for Lockally::DedicatedIPRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::DedicatedIPRequest do
  #let(:instance) { Lockally::DedicatedIPRequest.new }

  describe 'test an instance of DedicatedIPRequest' do
    it 'should create an instance of DedicatedIPRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::DedicatedIPRequest)
    end
  end
  ...
  describe 'test attribute "admin_note"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
