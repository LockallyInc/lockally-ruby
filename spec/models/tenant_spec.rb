...
# Unit tests for Lockally::Tenant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::Tenant do
  #let(:instance) { Lockally::Tenant.new }

  describe 'test an instance of Tenant' do
    it 'should create an instance of Tenant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::Tenant)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["active", "suspended", "closing", "closed"])
  ...
  describe 'test attribute "hard_delete_after"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
