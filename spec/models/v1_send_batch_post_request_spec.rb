...
# Unit tests for Lockally::V1SendBatchPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1SendBatchPostRequest do
  #let(:instance) { Lockally::V1SendBatchPostRequest.new }

  describe 'test an instance of V1SendBatchPostRequest' do
    it 'should create an instance of V1SendBatchPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1SendBatchPostRequest)
    end
  end
