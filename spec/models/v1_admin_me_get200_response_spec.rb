...
# Unit tests for Lockally::V1AdminMeGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1AdminMeGet200Response do
  #let(:instance) { Lockally::V1AdminMeGet200Response.new }

  describe 'test an instance of V1AdminMeGet200Response' do
    it 'should create an instance of V1AdminMeGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1AdminMeGet200Response)
    end
  end
