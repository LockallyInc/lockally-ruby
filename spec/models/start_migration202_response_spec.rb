...
# Unit tests for Lockally::StartMigration202Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::StartMigration202Response do
  #let(:instance) { Lockally::StartMigration202Response.new }

  describe 'test an instance of StartMigration202Response' do
    it 'should create an instance of StartMigration202Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::StartMigration202Response)
    end
  end
  ...
  describe 'test attribute "mailboxes_queued"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
