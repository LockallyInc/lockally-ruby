...
# Unit tests for Lockally::DiscoverMigration202Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::DiscoverMigration202Response do
  #let(:instance) { Lockally::DiscoverMigration202Response.new }

  describe 'test an instance of DiscoverMigration202Response' do
    it 'should create an instance of DiscoverMigration202Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::DiscoverMigration202Response)
    end
  end
