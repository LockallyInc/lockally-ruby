...
# Unit tests for Lockally::CreateMigrationCredentialRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateMigrationCredentialRequest do
  #let(:instance) { Lockally::CreateMigrationCredentialRequest.new }

  describe 'test an instance of CreateMigrationCredentialRequest' do
    it 'should create an instance of CreateMigrationCredentialRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateMigrationCredentialRequest)
    end
  end
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["imap", "google", "microsoft", "generic"])
