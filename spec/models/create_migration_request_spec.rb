...
# Unit tests for Lockally::CreateMigrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateMigrationRequest do
  #let(:instance) { Lockally::CreateMigrationRequest.new }

  describe 'test an instance of CreateMigrationRequest' do
    it 'should create an instance of CreateMigrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateMigrationRequest)
    end
  end
