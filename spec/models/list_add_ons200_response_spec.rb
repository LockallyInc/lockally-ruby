...
# Unit tests for Lockally::ListAddOns200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::ListAddOns200Response do
  #let(:instance) { Lockally::ListAddOns200Response.new }

  describe 'test an instance of ListAddOns200Response' do
    it 'should create an instance of ListAddOns200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::ListAddOns200Response)
    end
  end
