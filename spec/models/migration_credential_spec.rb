...
# Unit tests for Lockally::MigrationCredential
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MigrationCredential do
  #let(:instance) { Lockally::MigrationCredential.new }

  describe 'test an instance of MigrationCredential' do
    it 'should create an instance of MigrationCredential' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MigrationCredential)
    end
  end
