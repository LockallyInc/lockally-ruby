...
# Unit tests for Lockally::CreateUnitsCheckout200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateUnitsCheckout200Response do
  #let(:instance) { Lockally::CreateUnitsCheckout200Response.new }

  describe 'test an instance of CreateUnitsCheckout200Response' do
    it 'should create an instance of CreateUnitsCheckout200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateUnitsCheckout200Response)
    end
  end
