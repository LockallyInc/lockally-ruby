...
# Unit tests for Lockally::GetDomainsStatus200ResponseDomainsInnerChecksInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetDomainsStatus200ResponseDomainsInnerChecksInner do
  #let(:instance) { Lockally::GetDomainsStatus200ResponseDomainsInnerChecksInner.new }

  describe 'test an instance of GetDomainsStatus200ResponseDomainsInnerChecksInner' do
    it 'should create an instance of GetDomainsStatus200ResponseDomainsInnerChecksInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetDomainsStatus200ResponseDomainsInnerChecksInner)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["healthy", "warning", "critical"])
