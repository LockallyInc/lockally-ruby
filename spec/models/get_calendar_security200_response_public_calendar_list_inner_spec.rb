...
# Unit tests for Lockally::GetCalendarSecurity200ResponsePublicCalendarListInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetCalendarSecurity200ResponsePublicCalendarListInner do
  #let(:instance) { Lockally::GetCalendarSecurity200ResponsePublicCalendarListInner.new }

  describe 'test an instance of GetCalendarSecurity200ResponsePublicCalendarListInner' do
    it 'should create an instance of GetCalendarSecurity200ResponsePublicCalendarListInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetCalendarSecurity200ResponsePublicCalendarListInner)
    end
  end
  ...
  describe 'test attribute "has_feed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
