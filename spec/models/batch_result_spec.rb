...
# Unit tests for Lockally::BatchResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::BatchResult do
  #let(:instance) { Lockally::BatchResult.new }

  describe 'test an instance of BatchResult' do
    it 'should create an instance of BatchResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::BatchResult)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["queued", "scheduled", "suppressed"])
