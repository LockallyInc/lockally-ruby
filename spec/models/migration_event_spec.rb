...
# Unit tests for Lockally::MigrationEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MigrationEvent do
  #let(:instance) { Lockally::MigrationEvent.new }

  describe 'test an instance of MigrationEvent' do
    it 'should create an instance of MigrationEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MigrationEvent)
    end
  end
