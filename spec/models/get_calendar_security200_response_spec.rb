...
# Unit tests for Lockally::GetCalendarSecurity200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetCalendarSecurity200Response do
  #let(:instance) { Lockally::GetCalendarSecurity200Response.new }

  describe 'test an instance of GetCalendarSecurity200Response' do
    it 'should create an instance of GetCalendarSecurity200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetCalendarSecurity200Response)
    end
  end

  describe 'test attribute "total_calendars"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "public_calendars"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "private_calendars"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "delegated_access"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "public_calendar_list"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
