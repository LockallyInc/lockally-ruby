...
# Unit tests for Lockally::CalendarIntegration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CalendarIntegration do
  #let(:instance) { Lockally::CalendarIntegration.new }

  describe 'test an instance of CalendarIntegration' do
    it 'should create an instance of CalendarIntegration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CalendarIntegration)
    end
  end
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["exchange", "google_calendar", "teams", "zoom", "erp"])
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["connected", "disconnected", "error", "syncing"])
      # validator.allowable_values.each do |value|
