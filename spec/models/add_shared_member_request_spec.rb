...
# Unit tests for Lockally::AddSharedMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::AddSharedMemberRequest do
  #let(:instance) { Lockally::AddSharedMemberRequest.new }

  describe 'test an instance of AddSharedMemberRequest' do
    it 'should create an instance of AddSharedMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::AddSharedMemberRequest)
    end
  end
