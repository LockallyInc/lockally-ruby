...
# Unit tests for Lockally::GetSecurity200ResponseStatsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::GetSecurity200ResponseStatsInner do
  #let(:instance) { Lockally::GetSecurity200ResponseStatsInner.new }

  describe 'test an instance of GetSecurity200ResponseStatsInner' do
    it 'should create an instance of GetSecurity200ResponseStatsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::GetSecurity200ResponseStatsInner)
    end
  end
