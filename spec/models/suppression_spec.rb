...
# Unit tests for Lockally::Suppression
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::Suppression do
  #let(:instance) { Lockally::Suppression.new }

  describe 'test an instance of Suppression' do
    it 'should create an instance of Suppression' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::Suppression)
    end
  end
