...
# Unit tests for Lockally::CreateContactListRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateContactListRequest do
  #let(:instance) { Lockally::CreateContactListRequest.new }

  describe 'test an instance of CreateContactListRequest' do
    it 'should create an instance of CreateContactListRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateContactListRequest)
    end
  end
