...
# Unit tests for Lockally::CreateResourceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateResourceRequest do
  #let(:instance) { Lockally::CreateResourceRequest.new }

  describe 'test an instance of CreateResourceRequest' do
    it 'should create an instance of CreateResourceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateResourceRequest)
    end
  end
