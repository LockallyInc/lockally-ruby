...
# Unit tests for Lockally::CreateEncryptionKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::CreateEncryptionKeyRequest do
  #let(:instance) { Lockally::CreateEncryptionKeyRequest.new }

  describe 'test an instance of CreateEncryptionKeyRequest' do
    it 'should create an instance of CreateEncryptionKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::CreateEncryptionKeyRequest)
    end
  end
