...
# Unit tests for Lockally::MigrationProgressMailboxesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::MigrationProgressMailboxesInner do
  #let(:instance) { Lockally::MigrationProgressMailboxesInner.new }

  describe 'test an instance of MigrationProgressMailboxesInner' do
    it 'should create an instance of MigrationProgressMailboxesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::MigrationProgressMailboxesInner)
    end
  end
