...
# Unit tests for Lockally::V1WebhooksIdPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1WebhooksIdPatchRequest do
  #let(:instance) { Lockally::V1WebhooksIdPatchRequest.new }

  describe 'test an instance of V1WebhooksIdPatchRequest' do
    it 'should create an instance of V1WebhooksIdPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1WebhooksIdPatchRequest)
    end
  end
