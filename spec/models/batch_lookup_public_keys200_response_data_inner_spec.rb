...
# Unit tests for Lockally::BatchLookupPublicKeys200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::BatchLookupPublicKeys200ResponseDataInner do
  #let(:instance) { Lockally::BatchLookupPublicKeys200ResponseDataInner.new }

  describe 'test an instance of BatchLookupPublicKeys200ResponseDataInner' do
    it 'should create an instance of BatchLookupPublicKeys200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::BatchLookupPublicKeys200ResponseDataInner)
    end
  end
