...
# Unit tests for Lockally::V1InboxesMailboxMessagesPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Lockally::V1InboxesMailboxMessagesPostRequest do
  #let(:instance) { Lockally::V1InboxesMailboxMessagesPostRequest.new }

  describe 'test an instance of V1InboxesMailboxMessagesPostRequest' do
    it 'should create an instance of V1InboxesMailboxMessagesPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Lockally::V1InboxesMailboxMessagesPostRequest)
    end
  end
